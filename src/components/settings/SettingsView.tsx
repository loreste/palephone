...
import { User, Volume2, Globe, Info, Server, Bell, Phone, LogOut, Sun, Moon, Palette, Shield, Monitor, Smartphone, Laptop, Trash2, Clock, Languages } from "lucide-react";
...
type SettingsTab = "account" | "audio" | "network" | "server" | "calls" | "call_analytics" | "call_groups" | "notifications" | "security" | "appearance" | "language" | "ooo" | "about";

const settingsTabs: { id: SettingsTab; labelKey: string; icon: typeof User }[] = [
  { id: "account", labelKey: "settings.account", icon: User },
  { id: "calls", labelKey: "settings.calls", icon: Phone },
  { id: "call_analytics", labelKey: "settings.analytics", icon: Phone },
  { id: "call_groups", labelKey: "settings.groups", icon: Phone },
  ...
  { id: "ooo", labelKey: "settings.ooo", icon: Clock },
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex gap-1 px-4 pb-3 flex-wrap">
        {settingsTabs.map(({ id, labelKey, icon: Icon }) => (
          <button
            key={id}
